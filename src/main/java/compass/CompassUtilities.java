...
;
	...
	private static final List<String> toolTipsText = Arrays.asList(
		...
		"ALTER SERVER ROLE securityadmin"+tttSeparator+"The securityadmin role is not currently supported; rewrite by granting superuser or CREATEROLE privileges",
		"ALTER SERVER ROLE dbcreator"+tttSeparator+"The dbcreator role is not currently supported; rewrite by granting CREATEDB privileges or superuser privileges",
		"ALTER SERVER ROLE processadmin"+tttSeparator+"The processadmin role is not currently supported; rewrite by granting superuser privileges or using pg_terminate_backend() with necessary permissions",
		"ALTER SERVER ROLE setupadmin"+tttSeparator+"The setupadmin role is not currently supported; rewrite by granting superuser privileges or use foreign data wrappers",
		"ALTER SERVER ROLE bulkadmin"+tttSeparator+"The bulkadmin role is not currently supported; rewrite by granting superuser privileges or use the COPY command",
		"ALTER SERVER ROLE diskadmin"+tttSeparator+"The diskadmin role is not currently supported; rewrite by granting superuser privileges or managing tablespaces",
		"ALTER SERVER ROLE serveradmin"+tttSeparator+"The serveradmin role is not currently supported; rewrite by granting superuser privileges",
		...
		"@@PGERROR"+tttSeparator+"@@PGERROR is a reserved variable name that was introduced by Babelfish; @@PGERROR cannot be used for declaring a variable or parameter; rename the variable/parameter",
		"@@\\w+"+CompassAnalyze.globalAtAtVarReference+tttSeparator+"This global @@variable is not currently supported",
		"@@\\w+"+CompassAnalyze.globalAtAtVarDeclared+tttSeparator+"This is a predefined T-SQL global @@variable name; it cannot be used for declaring a variable or parameter; rename the variable/parameter",
		"@@\\w+"+CompassAnalyze.globalAtAtVarNamedArg+tttSeparator+"This is a predefined T-SQL global @@variable name; it cannot be used for a named argument; rename the argument and parameter",
		...
		CompassAnalyze.VarDeclareAtAt+tttSeparator+"Local variable name starting with '@@' can be declared, but cannot currently be referenced; rename the variable",
		CompassAnalyze.ProcParDeclareAtAt+tttSeparator+"Procedure parameter name starting with '@@' is not currently supported; rename the parameter",
		CompassAnalyze.FuncParDeclareAtAt+tttSeparator+"Function parameter name starting with '@@' is not currently supported; rename the parameter",
		CompassAnalyze.FuncTypeDeclareAtAt+tttSeparator+"Function return table name starting with '@@' is not currently supported; rename the variable",
		CompassAnalyze.NamedArgAtAt+tttSeparator+"Named procedure call arguments with name starting with '@@' is not currently supported; rename the parameter",
