...
public class CompassUtilities {
	...
	public static final String thisProgVersion      = "2026-09";
	public static final String thisProgVersionDate  = "September 2026";
	...
	public static List<String> BabelfishVersionList   = Arrays.asList("1.0.0", "1.1.0", "1.2.0", "1.3.0", "1.4.0", "1.5.0", "2.1.0",  "2.2.0", "2.3.0", "2.4.0", "3.1.0", "3.2.0", "3.3.0", "3.4.0", "3.5.0", "4.0.0", "4.1.0", "4.2.0", "4.3.0", "4.4.0", "4.5.0", "4.6.0", "4.7.0", "4.8.0", "5.1.0", "5.2.0", "5.3.0", "5.4.0", "5.5.0", "5.6.0", "5.7.0", "6.0.0", "6.1.0", "6.2.0");
	public static List<String> BabelfishPGVersionList = Arrays.asList("13.4",  "13.5",  "13.6",  "13.7",  "13.8",  "13.9",  "14.3/4", "14.5",  "14.6",  "14.7",  "15.2",  "15.3",  "15.4",  "15.5",  "15.6",  "16.1",  "16.2",  "16.3",  "16.4",  "16.6",  "16.8",  "16.9",  "16.10", "16.11", "17.4",  "17.5",  "17.6",  "17.7",  "17.9",  "17.10", "17.11", "18.3",  "18.4", "18.5");
...
;
	...
	private static final List<String> toolTipsText = Arrays.asList(
		...
		"Legacy schema name"+tttSeparator+"This is a legacy schema name that is not supported by Babelfish by default; either create the schema or use a different schema name instead",
