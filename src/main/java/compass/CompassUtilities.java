...
;
	...
	private static final List<String> toolTipsText = Arrays.asList(
		...
		"SET DATEFORMAT"+tttSeparator+"Currently, SET DATEFORMAT is not supported. Use escape hatch "+escapeHatchSessionSettingsText+" to suppress the resulting error message",
		...
		"EXECUTE procedure sp_addlogin"+tttSeparator+"System stored procedure sp_addlogin is not currently supported; use CREATE LOGIN instead",
		"EXECUTE procedure sp_droplogin"+tttSeparator+"System stored procedure sp_droplogin is not currently supported; use DROP LOGIN instead",
		"EXECUTE procedure sp_adduser"+tttSeparator+"System stored procedure sp_adduser is not currently supported; use CREATE USER instead",
		"EXECUTE procedure sp_dropuser"+tttSeparator+"System stored procedure sp_dropuser is not currently supported; use DROP USER instead",
